                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><Link href="/#about" className="hover:text-white hover:border-b hover:border-white/50 transition-all pb-0.5">The Resort</Link></li>
                            <li><Link href="/#experiences" className="hover:text-white hover:border-b hover:border-white/50 transition-all pb-0.5">Accommodations</Link></li>
                            <li><Link href="/gallery" className="hover:text-white hover:border-b hover:border-white/50 transition-all pb-0.5">Gallery</Link></li>
                            <li><Link href="/#contact" className="hover:text-white hover:border-b hover:border-white/50 transition-all pb-0.5">Contact</Link></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <div className="mt-6">
                            <button
                                ...
                                className="text-sm border-b border-stone-700 hover:text-white hover:border-white transition-colors pb-0.5"
                            >
